...
<body class="bg-gray-100" x-data="{ cartOpen: false, isOpen: false }">
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="w-full text-gray-700 md:text-center text-2xl font-semibold">
                    <a href="/">Your Online Store</a>
                </div>
                <div class="flex items-center justify-end w-full relative">
                    <!-- User dropdown -->
                    <div class="relative mx-3">
                        <button @click="userDropdownOpen = !userDropdownOpen" class="text-gray-600 focus:outline-none mx-4 sm:mx-0">
                            <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-6.67 0-10 3.33-10 10v1h20v-1c0-6.67-3.33-10-10-10z"></path>
                            </svg>
                        </button>
                        ...
                        <div
                            ...
                            class="absolute right-0 top-full mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-20"
                            @click.away="userDropdownOpen = false"
                        >
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Thông Tin Cá Nhân</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Sign In</a>
